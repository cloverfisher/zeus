...
public class ZeusUser{
	...
	public static final ZeusUser ADMIN=new ZeusUser(){
		public String getEmail() {return "zhoufang@taobao.com";};
		public String getName() {return "周方";};
		public String getPhone() {return "15068101234";};
		public String getUid() {return "zhoufang";};
	};
	@Id
	@GeneratedValue
	private Long id;
